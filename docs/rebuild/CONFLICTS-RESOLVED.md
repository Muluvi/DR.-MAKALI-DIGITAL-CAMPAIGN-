...
| R-19 | Two USSD menus (§5.2.1.2 four options with a manifesto sub-menu; §5.2.3.3 six options) | One menu, §5.2.3.3's, drawn as `fig-5-2-3-ussd-menu`. §5.2.1.2 points to it. | The section that governs the offline layer owns the menu. | Applied |
| R-20 | §4.6 `[CONFIRM/EDIT]`: does the 82/18 split move with the 2023/24 internet rate? | **It stands.** On 26.2%, digital still reaches at most 158,696 voters, 41,304 short of 200,000; the split is re-read monthly. | Approved by Firefly, September 2026. | Applied |
| R-21 | Four placeholders that were Firefly's own recommendations | Settled on approval (September 2026): data-subject response within **14 days** (5.7.8); ad kill rule at **1.5% CTR** (5.2.1.3); **FIDO2 hardware keys, two per account holder** (F.8); the **campaign holds the ad account**, Firefly on Analyst and Advertiser access (5.7.3). | Approved recommendations. | Applied |
| R-22 | Annex C: the two Mizani rounds' sample size and undecided share marked `[DATA NEEDED — not published]` | Stated as **Not published**: a fact about the release, not a gap any document closes. | Non-negotiable 5 applies to data that exists; this does not. | Applied |
| R-23 | 2022 governor results cited to media (T2); two Musila totals "neither preferred" | Cited to the certified result (Form 37C) per Firefly's Public Data & Evidence Audit (24 Sep 2026): Malombe **198,004** and Musila **117,606**, both T1. The certified 35.77% share matches 117,606, so The Star's 114,606 is kept only as the media variant. | The certified document settles the dispute. | Applied |
| R-24 | Turnout: a 62% modelling constant, no certified figure | Certified 2022 turnout **61.7%** (328,760 valid of 532,758, T1). Every calculation now carries that rate forward to 2027, stated as an assumption. Routes recalculate from it: A −76,478, B −69,083, C −75,818, D −81,653; no route clears 200,000. | Data wins over a constant. | Applied |
| R-25 | His 2022 Kitui Central vote total `[DATA NEEDED]` | **30,954** (T1, IEBC as gazetted); Boniface Musambi 9,866. Early media totals of 30,571 and 31,754 are recorded in the data layer and not used. | Audit. | Applied |
| R-26 | FY2026/27 envelope: KSh 13.79bn total, 1.04bn grants (secondary reporting) | The audit reads **13.78bn** and **1.03bn**. Both readings are shown as a dispute; neither is preferred until the Paper is cited. | Non-negotiable 5: a dispute is shown, not collapsed. | Applied |
| R-27 | ECVR: "the 30-day drive" | Labelled **Phase 1** (to 28 April 2026); a second phase ran 25 June to 25 July 2026 (IEBC gazette notice, 24 June 2026). The derived remainder may carry some of it, and says so. | Audit. | Applied |
| R-28 | Health insurance, stunting, solid fuel, livestock households, migration, national ICT by age/residence/education/city, Lower Eastern radio shares, boda-boda, NG-CDF allocation, X followers | Entered with the tier and caveat the audit gives: national figures labelled national; Lower Eastern radio labelled regional and earlier; boda-boda an estimate; migration context, not a voter count; stunting 25.1% (KDHS) beside 29.3% (CIDP). Where the Kitui-specific figure is still missing, a narrower `[DATA NEEDED]` stays. | Audit, September 2026. | Applied |
| R-29 | 33 data gaps, 3 items to confirm and 17 placeholders left open after the audit | Removed where Firefly supplied nothing (24 Sep 2026); Week 1 measurements stated as set in Week 1; requirements kept without markers. Logged in REPLACEMENTS.md. | Instruction: "The items I have not shared information on may be removed." | Applied |
| R-30 | Segment sizes (4.3) marked `[DATA NEEDED]` or `[VERIFIED FIGURE REQUIRED]` | Stated as **not published**; register counts stay as ceilings, not support. No size is estimated. | Non-negotiable 5 is kept: nothing is estimated in their place. | Applied |
| R-31 | Open items list (`fig-6-2`) | Removed; `fig-3-10-gaps` keeps the three named analytical limits (ward-level preference; 2013 and 2017 ward returns), which no public source publishes. | Those are limits of the analysis, not items to supply. | Applied |
