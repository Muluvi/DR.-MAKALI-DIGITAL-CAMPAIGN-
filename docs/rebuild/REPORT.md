...
| `fig-6-2-open-items` | 6.2 | What is still open? | Generated from every marker in this document (scripts/build-open-items.ts) (data needed) | matrix |
...
horizontally (every route, JS on and off). The pilot was also checked in greyscale and print.
...
the 40% threshold removed. C-1 to C-21 are applied; **C-22** (endorsement count per sub-county or
in total) stays open as a `[CONFIRM/EDIT]`. R-1 to R-18 record what the rebuild found and changed.

## 6. What is still open

Generated by `scripts/build-open-items.ts` from every marker in the served content, every
`needed` figure in the data layer and every `needed` row in a figure: **44 data gaps, 4 items to
confirm, 21 placeholders.** The same list renders as `fig-3-10-gaps` (data gaps) and
...
| DATA NEEDED | Kitui listenership by station | GeoPoll or KARF county release | Audience-research publishers | Section 3.8.1 |
...
| DATA NEEDED | The published rounds, and what each one measured | not published | To be named | Section C.1 |
...
| DATA NEEDED | Which channel does which job | Kitui listenership by station | Audience-research publishers | Section 4.6 |
...
| DATA NEEDED | Dr. Mulu: posts per week, median shares, ads live | public pages, Week 1 audit | His team: the Week 1 export | Figure fig-2-9-channels |
| DATA NEEDED | Irene Kasalu: posts per week, median shares, ads live | public pages, Week 1 audit | His team: the Week 1 export | Figure fig-2-9-channels |
| DATA NEEDED | Enoch Wambua: posts per week, median shares, ads live | public pages, Week 1 audit | His team: the Week 1 export | Figure fig-2-9-channels |
| DATA NEEDED | Julius Malombe: posts per week, median shares, ads live | public pages, Week 1 audit | His team: the Week 1 export | Figure fig-2-9-channels |
| DATA NEEDED | Reach against the vote map: as displayed, or the figure | Meta Insights export, Week 1 | His team: the Week 1 export | Figure fig-3-9-audit |
| DATA NEEDED | Ninety days, coded: as displayed, or the figure | Meta Insights export, Week 1 | His team: the Week 1 export | Figure fig-3-9-audit |
...
| CONFIRM/EDIT | the 82/18 weighting was set when digital reach was put at 13.6% of residents (the 2019 census rate). On the 2023/24 rate it is 26.2%. Firefly to confirm… | Campaign decision | The campaign | Section 4.6 |
...
| Placeholder | To insert: specified hardware security key model — two keys per critical account holder for redundancy | At contracting | The campaign | Section F.8 |
| Placeholder | To insert: baseline audit results — Week 1 deliverable | At contracting | The campaign | Section 5.3 |
| Placeholder | To insert: native-speaker developed | At contracting | The campaign | Section 5.4.1 |
| Placeholder | To insert: target | At contracting | The campaign | Section 5.4.9 |
| Placeholder | To insert: independent Kenyan qualitative research facilitator; Firefly to recommend, campaign to appoint | At contracting | The campaign | Section 5.6.10 |
| Placeholder | Campaign decision required: Decision rights and content approval | Campaign decision | The campaign | Section 5.7.3 |
| Placeholder | Campaign decision required: confirmed in the Section 5.7.9 scope memorandum | Campaign decision | The campaign | Section 5.7.5 |
| Placeholder | To insert: SLA — recommend 14 days | At contracting | The campaign | Section 5.7.8 |
| Placeholder | To insert: named Kenyan data-protection / electoral-law specialist — to be appointed by the campaign | At contracting | The campaign | Section 5.7.9 |
| Placeholder | To insert: vendor — selected at contracting | At contracting | The campaign | Section 5.8.7 |
| Placeholder | Campaign decision required: anything further the campaign wishes placed outside scope | Campaign decision | The campaign | Section 5.1.3 |
| Placeholder | Verified figure required: Kitui Central holds 77,764 registered voters (Tier 1), but a register count is not a support estimate | Campaign decision | The campaign | Section 4.3 |
| Placeholder | Verified figure required: the Mwingi constituencies hold 200,198 registered voters (Tier 1), which is the ceiling on this universe and not its size | Campaign decision | The campaign | Section 4.3 |
| Placeholder | To insert: verified number | At contracting | The campaign | Section 4.4.6 |
| Placeholder | Kikamba review needed: the Kikamba name for each pillar, from the native-speaker reviewer named in Section 6.1. None is invented here, and none should be… | Kikamba reviewer | Kikamba reviewer | Section 4.5 |
| Placeholder | Confirm: against the Week 1 export before this is put in front of him — it must be his actual week, not a characterisation of it | Campaign decision | The campaign | Section 4.5.5 |
| Placeholder | To insert: shortcode | At contracting | The campaign | Section 5.2.4.4; Section 5.2.3.3; Section 5.2.1.1; Section 5.2.1.2 |
| Placeholder | To insert: sender ID | At contracting | The campaign | Section 5.2.1.2 |
| Placeholder | To insert: threshold — recommend 1.5% CTR | At contracting | The campaign | Section 5.2.1.3 |
| Placeholder | To insert: additional authentic Kikamba proverbs and phrases — all to be reviewed and corrected by a native speaker before any publication. The examples… | At contracting | The campaign | Section 5.2.1.4 |
| Placeholder | To insert: Kenya National Association of the Deaf or an accredited interpreter service | At contracting | The campaign | Section 5.2.1.4 |
...
- **Portrait beside the map.** The portrait sits beside the title in the hero, with the tile map
  directly beneath rather than side by side.
