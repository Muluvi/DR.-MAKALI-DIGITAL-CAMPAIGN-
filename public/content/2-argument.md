...
### 2.1.1 The evidence behind the claim
...
### 2.1.3 Answering the charge that discipline is cold
...
## 2.5 Voter segments and the messaging framework
...
Under the campaign's Provenance Discipline (Section 6.1.2), **no claim is made without an attached primary empirical source**. Every message delivered—from a 160-character Kikamba SMS to a 2-hour radio debate—is grounded in certified parliamentary scorecards, Auditor-General reports, or KNBS economic data.
...
### 2.6.1 The central claim and its three pillars
...
### 2.6.2 Answering disinformation
...
### 2.7.2 What we say on each channel, and in what format

Two views of the same channel mix: the message and its supporting evidence,
