...
### 11.1.1 Two-Stage Campaign Scorecards & 200,000 Vote Indicator Framework
...
**Stage 2: the general election scorecard.** The general election phase focuses on systematic voter mobilization, ground network readiness, and polling station defense to cross the 200,000-vote winning threshold.
...
**The indicator framework, anchored to the vote threshold.** In accordance with the foundational strategic doctrine established in **Section 11.2.3**, the campaign rejects vanity metrics—such as social media follower counts, video views, impressions, and post likes—as actionable indicators of political strength. In a county where ~86% of registered voters reside offline in rural agrarian settings, digital engagement metrics correlate weakly with ballot-box outcomes and create dangerous operational complacency.
...
### 11.2.3 Performance Governance: Vanity Metric Exclusion & Executive Escalation
...
**Performance governance and executive escalation.** To ensure accountability across all divisions, the KPI framework is embedded in a rigid governance rhythm:
...
### 11.3.1 Kitui Message Lab: Operational Structure, Hypotheses & Feedback Loops
...
**Qualitative hypotheses, feedback loops and KPIs.** To ensure offline reality shapes digital execution, the message lab systematically evaluates:
