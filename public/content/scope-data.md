...
### 8.12.1 Voter Data Architecture & Data Protection Act Compliance
...
**The Data Protection Act 2019, applied.** Political messaging, bulk SMS broadcasting, and voter profiling operate under strict statutory oversight in Kenya. Non-compliance risks severe criminal penalties, regulatory injunctions, and catastrophic brand damage to Dr. Mulu's integrity-driven platform.
...
### 8.13.1 Voter Scoring Model: Objective, Data Inputs, Methodology & Feature Variables
...
**This entire section is conditional on the compliance gate in Section 12.5.5.**
...
**Data sources.** * **IEBC Voter Register:** name, gender, age bracket, polling station, ward,
...
consent-based
* **Field canvass returns** (Section 8.9)
...
them. See Section 12.5.4.

**Modelling methodology.** | Model | Purpose | Strength |
|---|---|---|
...
**Model variables.** | Variable | Description | Source | Type | Format |
|---|---|---|---|---|
...
| `field_contact_outcome` | **Canvass result (Section 8.9)** | Field team | Categorical | Support/Undecided/Oppose/No contact |
...
### 8.13.5 Model Operationalization: Validation Metrics, Field Activation & Legal Gate
...
**Putting the model to work.** * **Ad targeting:** scored segments as custom audiences on Meta, Google, TikTok
...
households first (Section 8.9)

**The compliance gate this depends on.** Model deployment is gated. If the Section 12.5.5 review does not clear
...
*   **Function & Purpose:** The centralized single-source-of-truth supporter data warehouse (Section 8.12.1). Stores supporter profiles, 40-ward geographic linkages, demographic classifications, volunteer skills, delegate tracking status, and contact history.
*   **Cost Structure:**
...
*   **DPA 2019 Exposure & Compliance:** **LOW TO MODERATE RISK.** Processes only publicly accessible posts and aggregated sentiment metadata. Compliant with Section 8.11 provided individual user profiles are not scraped or merged into private voter records without consent.
...
### 8.14.2 Technology Procurement: Vendor Matrix, SaaS Risk & Security Controls
...
**Technical risk and security protocols.** To ensure 100% operational uptime and protect campaign systems from infiltration or cyber disruption:
...
### 8.15.1 Attribution Architecture, Offline Conversions & Media Benchmarks
...
| **Field canvass contact** | Direct event | Ward champion form (Section 8.9) |
...
**Key metrics and benchmarks.** | Metric | Definition | Global benchmark | Campaign target |
|---|---|---|---|
...
### 8.15.3 Analytics Capability Roadmap & Intellectual Property/Data Ownership
...
| **2 — Predictive** | Phase 1–2 | Voter scoring live; field-digital loop operating; audience segments driven by score | **Section 12.5.5 compliance gate cleared** | Data Analyst (surge) |
...
**Who owns the data.** A **single named data-governance owner** is accountable for both analytics
...
**24 hours** — the standard the Section 13.2.4 drill tests
* Owns the deletion schedule and executes it (Section 12.5.4)
* Is the campaign's standing point of contact for the Section 12.5.5 compliance
reviewer
