...
**Two cores, and they are not the same team.** The chart above is the **campaign's** command structure — a Campaign Manager and three functional leads, four roles in total. The **3-person Firefly core** named at every scope level in Section 10.1 is the delivery team this proposal supplies, and it works to that structure rather than replacing any part of it. Where this section says "four-person core" it means the campaign's; where Section 10.1 says "3-person core" it means Firefly's.
