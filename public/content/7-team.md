...
### 7.2.1 Why the delivery model is lean

`[Confirm the size of the core team. The argument below reasons from a "4-person core command structure"; the core team table beneath it lists three retained roles, and Sections 9.2.5 and 9.2.6 price a "3-person core" in all three budget tiers. Neither figure has been changed here.]`
...
### 7.2.2 The core team, and who owns what
...
#### Leadership roles and ownership, in full
...
### 7.2.4 Reporting lines, and how disagreements escalate
...
#### Leadership touchpoints, in full
