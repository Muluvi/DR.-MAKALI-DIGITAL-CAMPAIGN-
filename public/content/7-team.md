...
### 7.2.1 A lean core with a defined surge
...
|---|---|---|
| **Data Analyst / Modeller** | Phase 1 onward (standard and premium tiers) | Predictive scoring, field-digital integration, attribution modelling. **Named data-governance owner** (Section 6.4.5) |
...
## 7.3 Leadership roles and governance rhythm
...
### 7.3.1 Why the delivery model is lean
...
### 7.3.2 Core leadership roles and who owns what
...
### 7.3.3 How disagreements escalate
