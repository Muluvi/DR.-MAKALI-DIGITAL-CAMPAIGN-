...
| Data Analyst / Modeller | Predictive scoring, attribution and field-digital integration, subject to compliance gate | Phase 1; Standard/Premium |
...
| Daily | Ground asset upload | Raw field photo/video edited and published within hours |
| Weekly | Strategy sync | Performance review, next-week calendar and itinerary alignment |
| Weekly | Creative/language review | Kikamba and cultural sign-off |
| Fortnightly | Ward champion call | Ground sentiment, distribution and leaderboard |
...
<div class="card"><h4>Week 2 — Launch system</h4><ul><li>Publish Phase −1 narrative architecture.</li><li>Start three-language daily publishing.</li><li>Launch flagship video and Kikamba voice-note format.</li><li>Begin earned-media/debate distribution.</li><li>Prepare consented SMS acquisition and USSD build.</li><li>Test message variants before scaling paid spend.</li></ul></div>
...
|---|---|---|---|
| Team | 4 incl. Kikamba producer | Core + data/community/volunteer/earned/video capacity | Full surge bench |
| Ad-spend guide | 15–20% of verified ceiling | 30–40% | 45–55% |
| Contact universe | ~60,000 | ~150,000 | ~250,000 |
| SMS/USSD | Limited SMS; no USSD | All 40 wards | All 40 wards + expanded diaspora layer |
| Analytics | Native dashboards | Predictive scoring + attribution + field integration | Licensed listening + full attribution |
...
- Maintain consent/audit trail for SMS, WhatsApp and fundraising contacts.
- Every SMS includes clear opt-out; honour immediately and permanently.
...
|---|---|
| USSD | Report issue from any phone; no internet required |
| SMS | Short-code issue submission |
| WhatsApp | Campaign line for reports and evidence |
...
- Test where residents in lower-connectivity locations actually obtain political information.
...
- Maintain deepfake/manipulated-media detection and rebuttal capability where budgeted.
...
- Plain-language summaries and audio alternatives where appropriate.
...
5. Verified IEBC expenditure ceiling.
6. Current ward-level registration data from the published IEBC file.
7. Existing NG-CDF/project record for verified proof points.
8. Approved budget tier.
...
| Current ward registration data received | <span class="placeholder">OPEN</span> | Campaign |
| Baseline digital audit completed | <span class="placeholder">OPEN</span> | Firefly |
| Compliance reviewer appointed | <span class="placeholder">OPEN</span> | Campaign |
| Voter-data processing signed off | <span class="placeholder">GATED</span> | Compliance reviewer |
| Native Kikamba producer confirmed | <span class="placeholder">OPEN</span> | Firefly |
| SMS/USSD shortcode confirmed | <span class="placeholder">OPEN</span> | Firefly / operator |
| Candidate/campaign approval matrix signed | <span class="placeholder">OPEN</span> | Campaign |
| Account access and security review complete | <span class="placeholder">OPEN</span> | Firefly / campaign |
| WCAG 2.1 AA audit pass | <span class="placeholder">OPEN</span> | Firefly |
...
5. **Operating model:** 3-person Firefly core plus explicit surge triggers.
6. **Economics:** Lean/Standard/Premium tied to verified statutory ceiling.
...
**Still requires client/counsel inputs:** the mandatory open items in the pre-launch checklist above.
</section>
...
|---|---|---|---|
| 8B.1 | Verified Kitui County expenditure ceiling — IEBC Gazette Notice No. 12251, 7 Aug 2026, First Schedule | Campaign | Phase −1, Week 2 |
| 2.3 | Current ward-level registered voter figures — IEBC published file | Campaign | Phase −1, Week 2 |
| 20 | Week 1 competitive digital baseline audit | Firefly | Phase −1, Week 1 |
| 8A.3 | Community manager activation threshold (recommend 150 inbound/day) | Firefly + campaign | Phase 1 |
| 8B.2 | Dedicated USSD code quotation | Firefly, at contracting | Phase 0 |
| 8B.5 | Tier ad spend as % of verified ceiling | Campaign | On tier selection |
| 8B.3 | Tested persuasion conversion rate | Firefly | Phase 2 |
| 9B.3 | USSD short code | Vendor allocation | Phase 0 |
| 9B.5 | Counsel confirmation on agent-network arrangements | Campaign counsel | Phase 1 |
| 10.3 | Verified petition and campaign figures used in social-proof framing | Firefly | Before publication |
| 11.3 | Ad kill-rate CTR threshold (recommend 1.5%) | Firefly + campaign | Phase 1 |
| 12A.4 | Endorsement target number | Campaign | Phase 1 |
| 14 | SMS keyword short code | Vendor allocation | Phase 0 |
| 16.4 | Data rights contact route and response SLA (recommend 14 days) | Campaign | Before charter publication |
| 16.5 | **Named Kenyan data-protection / electoral-law specialist** | **Campaign — long-lead item** | **Phase −1, Week 2** |
| 16A.2 | Hardware security key procurement cost | Firefly | Phase −1, Week 1 |
| 16A.5 | Deepfake detection vendor and cost (premium tier) | Firefly, at contracting | Phase 2 |
| 18 | Additional verified Kikamba proverbs and phrases | Kikamba producer | Before any publication |
| 18A.2 | KSL interpreter service appointment | Campaign | Phase 0 |
| 19A.2 | Independent qualitative research facilitator | Campaign, on Firefly recommendation | Phase −1 |
| 20 | Kikamba campaign hashtag | Kikamba producer | Phase 1 |
| 23 | Firefly contact details | Firefly | Before submission |
...
Registration, 30 April 2026; IEBC statement on the register and diaspora
registration, 20 August 2026; Election Campaign Financing Regulations, 2026 and
Gazette Notice No. 12251, 7 August 2026, as reported in the Kenyan press.

**Connectivity** — Communications Authority of Kenya Sector Statistics Reports,
Q2 and Q3 FY2025/26. Platform audience figures from published advertising-tool
data (NapoleonCat, May 2026; DataReportal Digital 2026 Kenya).

**Data protection** — Data Protection Act 2019; ODPC penalty determinations as
publicly reported; the industry code governing bulk political messaging.

**County demographics and development** — KNBS 2019 Kenya Population and
Housing Census; NDMA Kitui County 2025 Long Rains Food and Nutrition Security
Assessment; Kitui County Fiscal Strategy Paper FY2026/27 as approved by the
County Assembly; published academic work on Kitui water access.

**Political context** — Published Mizani Africa surveys (June and 7 August
2026) as reported; Kenyan press reporting on the Wiper nomination process and
the gubernatorial field.

**Candidate record** — Parliament of Kenya official member record; Kitui
Central NG-CDF published materials; Kenyan press reporting.

**AI and information integrity** — Preliminary Report of the Independent
International Scientific Panel on Artificial Intelligence, July 2026;
EU-funded analysis of Kenya's 2025 digital information ecosystem; Kenyan press
reporting on AI-generated political content.

**Media ownership** — Publicly reported ownership associations for Kamba-language
radio stations. **This mapping should be independently verified by the campaign
and treated as subject to change.**
