...
### 3.1.1 The Wiper Nomination Contest & Opinion-Poll Mechanism
...
**Where the opinion-poll mechanism stands.** > **The party's name changed in 2025.** The Office of the Registrar of Political Parties issued a
...
**What the poll would measure.** To protect the campaign against biased or unweighted polling results, the digital and analytical teams must evaluate any party-commissioned polling instrument against these strict research parameters:
...
### 3.1.4 Baseline Polling Standings, Deficit Analysis & Home-Base Limits
...
**The polling gap, as sourced.** Three published rounds exist, from **two different pollsters**. They are set out together and are
...
**Two things the home base cannot be assumed to do.** **Kitui Central will be fighting its own contest.** Stephen Kilonzo ("Kitundumo") has reportedly
...
> **The evidence standard (3.2) is in Annex A**, with the three source tiers every figure in
...
### 3.3.4 County Demographic Profile, Resource Envelope & Connectivity
...
**Who lives here, and what they can reach online.** Kitui County's vast physical and demographic characteristics define its developmental and electoral context:
