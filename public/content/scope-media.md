...
### 8.7.2 Press Operations: Journalist Engagement & Candidate Broadcast Training
...
**Candidate media training.** Three sessions, plus refreshers:
...
### 8.7.4 Debate & Forum Playbook: Rules of Engagement & Rebuttal Matrix
...
**Pre-drafted response lines.** Prepared, verified, and rehearsed in drills. Each is a structure, not a script —
...
### 8.7.7 Earned Broadcast Strategy: Gatekeeper Circumvention & Data-Led Pitching
...
**How we pitch: evidence first.** To capture objective news coverage on mainstream national and regional platforms without paying extortionate broadcast gatekeeper fees, the press desk operates an **Evidence-First Pitch Engine**:
