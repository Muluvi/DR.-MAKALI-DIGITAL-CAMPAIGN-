...
*   **Where he has never held office:**
    ...
    3.  **Kitui East (outside the pool):** Total **65,377 registered voters** (particularly Endau/Malalani, Voo/Kyamatu, and Mutitu/Kaliku). He has not held office here either, but Kitui East is not counted in the pool below; it is a direct-contact target on the party-flow finding in Section 3.6.
