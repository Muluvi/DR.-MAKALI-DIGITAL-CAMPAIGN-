...
### 8.1.1 Platform Operations: Digital Footprint, Organic Content & Targeted Ads
...
* **Crisis and reputation management:** Continuous sentiment monitoring across platforms. Rapid-response statements managing emerging narratives or opponent claims. Real-time monitoring and countering of misinformation and manipulated media (Sections 7.1 and 13.3).
...
### 8.2.1 Service Delivery Tracker: Objectives, System Architecture & Ingestion Flow
...
**What it is.** A simple public tool through which any Kitui resident can report and follow up
...
### 8.2.4 Service Delivery Tracker: UX Specifications, Political Utility & KPIs
...
**What it is worth to the campaign.** * **Narrative:** the strongest possible proof of the Verification pillar
...
**Build.** Built on the USSD/SMS infrastructure the campaign is already deploying (Section
...
**Tracker KPIs.** | Metric | Phase 1 | Phase 2 | Phase 3 |
|---|---|---|---|
...
### 8.3.4 Content Operations: Production Calendar, Sign-Off Gate & Asset Library
...
**Who approves what, and when.** To prevent defamatory statements, policy contradictions, electoral code infractions, or Data Protection Act (DPA) violations, **no asset may be broadcast or printed without passing through the 4-Step Governance Gateway**:
...
**The asset library.** All creative assets are stored in a centralized, cloud-backed Digital Asset Management repository structured as follows:
...
### 8.4.1 AI-Assisted Creative: Ethical Guardrails, Tooling Stack & Testing Cycle
...
**Tools and platforms.** | Tool | Function | Management |
|---|---|---|
...
**The weekly testing cycle.** * Minimum 5 ad variations per objective per platform
...
**Performance benchmarks.** | Metric | Global standard | Campaign target |
|---|---|---|
...
### 8.5.1 Universal Accessibility: Standards, Production Commitments & Verification KPIs

*In a county where 13.0% of the population never attended school,
accessibility is reach, not compliance theatre.*

**The case.** * **13.0% of Kitui residents have never attended school**; only 17.4% completed
secondary education
...
**The commitments.** | Area | Commitment |
|---|---|
...
**Why this is scope, not an annex.** The plain-language and audio versions are not a parallel accessibility track —
...
**Accessibility KPIs.** | Metric | Target |
|---|---|
