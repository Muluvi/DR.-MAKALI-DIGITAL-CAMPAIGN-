...
> **Message assignment by segment (7.1.2) and by channel (7.1.3) is in Annex C.** Those two
...
### 7.2.1 Persuasive Framing: Ethical Standards, Core Principles & Worked Examples
...
**The principles we apply.** | Principle | Definition | Campaign application |
|---|---|---|
...
**Framing, worked through in examples.** **Water scarcity**
...
### 7.3.1 Channel-by-Language Matrix: Kikamba, Kiswahili & English Allocation
...
### 7.3.2 Dialect Standards, Lexical Registers & Editorial Sign-Off
...
**The production and quality-control pipeline.** Running a synchronized three-language communications operation introduces severe version-drift and contradiction risks. The campaign implements a rigid **Translation & Quality-Control Gateway**:
