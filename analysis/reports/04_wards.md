...
| Recognition gap | DROPPED | 0.25 | — | No baseline survey has been run. This is the feature the campaign's own diagnosis depends on, and it carries the second-highest weight in the file. |
...
| 2022 party strength | DROPPED | 0.10 | — | Ward-level 2022 results are not published in the pack. Pack gap 7. |

**Nothing was imputed.** The five dropped features carry 70% of the stated weight between them. That weight was not redistributed by judgement — the surviving weights were renormalised arithmetically, which with one feature means it takes the whole 1.0.
...
- **[DATA NEEDED]** Recognition gap — No baseline survey has been run. This is the feature the campaign's own diagnosis depends on, and it carries the second-highest weight in the file.
