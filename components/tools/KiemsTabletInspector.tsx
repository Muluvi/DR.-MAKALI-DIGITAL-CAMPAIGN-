...
export function KiemsTabletInspector() {
  ...
  return (
    <div className="not-prose my-8 rounded-2xl border border-line bg-surface p-4 sm:p-6 shadow-xs">
      ...
      <div className="max-w-3xl mx-auto rounded-3xl bg-[#1e232d] border-8 border-[#323946] p-3 sm:p-5 shadow-2xl text-slate-100">
        ...
        {/* Screen Area */}
        <div className="rounded-xl bg-[#0e1218] border border-white/10 p-4 min-h-[360px] flex flex-col justify-between">
