...
/**
 * §5.5.1's three service levels, as one segmented control driving one panel.
 *
 ...
 * every string is the cell as §5.5.2 prints it, read from data/tier-matrix.ts.
 *
