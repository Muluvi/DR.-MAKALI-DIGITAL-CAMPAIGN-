...
/**
 * the three scope levels section's three service levels, as one segmented control driving one panel.
 *
 ...
 * every string is the cell as the scope levels compared section prints it, read from data/tier-matrix.ts.
 *
