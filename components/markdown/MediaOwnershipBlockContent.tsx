...
/**
 * Media ownership map (the who owns the Kamba-language stations, and who they favour section). The strategic point: the highest-reach
 * stations on the who owns the Kamba-language stations, and who they favour section's own reading are controlled by a rival or the party gatekeeper,
  ...
  return (
    <div className="not-prose bg-card border border-line rounded-2xl p-4 sm:p-5 shadow-sm my-6 print-avoid-break">
      ...
      <p className="t-small text-muted mb-3 leading-relaxed pl-3.5">
        Reach is a qualitative reading of the &quot;Campaign posture&quot; column beside it, not a measured
