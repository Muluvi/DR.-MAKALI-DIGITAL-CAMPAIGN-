...
const STRATEGIC_PILLARS: StrategicPillar[] = [
  ...
  },
  {
    ...
    tangibleProofPoint: "Public Service-Delivery Tracker (the workstream 1 — Owned platforms and the service-delivery tracker section) operational on USSD, SMS, WhatsApp, and Web.",
