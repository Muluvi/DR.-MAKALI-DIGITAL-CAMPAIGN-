...
/**
 * The nomination path (§1.1) — the highest-stakes Tier 3 claim in the document, since
  ...
  return (
    <div className="not-prose my-6 rounded-2xl border-2 border-dashed border-danger/40 bg-paper p-4 sm:p-5 print-avoid-break">
      <div className="flex items-center gap-2 mb-2">
        <TierBadge tier={3} />
        <span className="t-micro font-black text-danger">Unconfirmed by Wiper</span>
      </div>
      ...
      <p className="t-label text-ink/80 leading-relaxed mb-3">{NOMINATION_METHOD_CLAIM.provenance.note}</p>

      <div className="rounded-xl border border-line/60 bg-card p-3">
        <div className="t-micro font-black text-ink mb-1.5">What would confirm this</div>
