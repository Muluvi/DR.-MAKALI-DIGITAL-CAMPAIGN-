...
const MODEL_VARIABLES: ModelVariable[] = [
  ...
  { variable: "field_contact_outcome", description: "Canvass result (Section 5.2.3.2)", source: "Field team", type: "Categorical", format: "Support/Undecided/Oppose/No contact", highlight: true },
