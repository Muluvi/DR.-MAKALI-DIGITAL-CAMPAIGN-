...
const DATA: FiscalBar[] = [
  { name: "Resource envelope (FY2026/27)", value: RESOURCE_ENVELOPE_FY2026_27.value, display: `${fmt(RESOURCE_ENVELOPE_FY2026_27.value)} — the what the governorship controls, and what it is worth section`, color: "#0056a8" },
  ...
  return (
    <div className="not-prose bg-card border border-line rounded-2xl p-4 sm:p-5 shadow-sm my-6 print-avoid-break">
      ...
      <p className="t-small text-muted mb-3 leading-relaxed pl-3.5">
        ...
        stated above and in the what the governorship controls, and what it is worth section, not a new estimate.
      </p>
