...
// The five sources the proposal itself cites for hard data (see Appendix B: Source Notes).
...
export const KNOWN_SOURCES = ["KNBS", "IEBC", "CA", "KIPPRA", "NDMA"] as const;
...
export function SourceLine({ sources }: { sources: string[] }) {
  ...
  return (
    <div className="flex items-center gap-1.5 px-4 sm:px-0 pt-2 pb-1 t-label font-semibold text-muted">
