...
/**
 * County fiscal and audit record (§3.3.7). Server component — the chart pairing this
...
export function FiscalAuditPanel() {
  return (
    <div className="bg-card border border-line rounded-2xl p-4 sm:p-5 shadow-sm my-6 print-avoid-break">
      ...
      <div className="not-prose fx-focus overflow-x-auto" tabIndex={0} role="group" aria-label="Fiscal audit table, scrollable">
