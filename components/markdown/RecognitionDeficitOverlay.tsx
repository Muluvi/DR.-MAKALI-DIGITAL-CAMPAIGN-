...
/**
 * the where he is not yet known, and whether it matters section — recognition deficit mapped against voter concentration.
 *
 * WHAT THIS DELIBERATELY DOES NOT SHOW: ward-level polling. No ward-level poll of this race
 * exists. Only two countywide Mizani data points are available (the governing constraint section), and the what ward-level data we still do not have section lists
 ...
 *
 * What replaces them is what the where he is not yet known, and whether it matters section actually asserts: a STRUCTURAL recognition status per
 ...
 * computed from data/ward-register.json rather than typed in; the where he is not yet known, and whether it matters section's own table is that same
...
/** Per the where he is not yet known, and whether it matters section: the anchor is Kitui Central, with Kitui West and Kitui Rural as the adjacent belt;
...
/** the where he is not yet known, and whether it matters section's "Total Decisive Deficit Pool" — Mwingi bloc plus Kitui South, both from the register. */
      ...
      <div className="px-4 py-3 bg-paper/60 border-t border-line space-y-2">
        ...
        <p className="t-small text-muted flex items-start gap-1.5">
          ...
          <span>
            ...
            from any survey. No ward-level poll of this race exists; the what ward-level data we still do not have section lists ward-level recognition data as a named
