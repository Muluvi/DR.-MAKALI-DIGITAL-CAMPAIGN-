...
// the what the governorship controls, and what it is worth section: "a total resource envelope of KSh13.79 billion, comprising roughly KSh11.64
...
const DATA: WaterfallStep[] = [
  ...
  { name: "Stated total", base: 0, value: STATED_TOTAL, display: "KSh13.79bn — as stated in the what the governorship controls, and what it is worth section", color: "#0b1a30", isTotal: true },
];
