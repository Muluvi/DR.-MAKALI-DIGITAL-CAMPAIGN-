...
/**
 * The wider competitor field (§B.5) — highest legal-risk section in the document.
 * Server component, deliberately plain: no adverse claim appears here that is not already
 * established, sourced, elsewhere in this document (electoral history, §2.2), and every
