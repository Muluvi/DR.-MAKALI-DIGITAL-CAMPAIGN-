...
// qualitative reading of how the proposal itself characterises each candidate in §3.5 —
...
const DATA: QuadrantPoint[] = [
  {
    ...
    note: "Leading on measured preference. Section 3.5 names fiscal competence as her exploitable gap, not her strength.",
    color: "#e31d2b",
  },
  {
    name: "Dr. Makali Mulu",
    ...
    note: "Deepest fiscal and M&E credentials in the field per Section 3.5 — the proposal's central strategic bet.",
    color: "#0056a8",
  },
  {
    ...
    note: "Section 3.5 cites steady party base as his strength; the text makes no fiscal-credibility claim about him.",
    color: "#8295a9",
  },
];
  ...
  return (
    <div className="bg-card border border-line rounded-2xl p-4 sm:p-5 shadow-sm my-6 print-avoid-break">
      ...
      <p className="t-small text-muted mb-3 leading-relaxed pl-3.5">
        Horizontal axis is measured survey data. Vertical axis is a qualitative editorial reading of Section 3.5&apos;s own
