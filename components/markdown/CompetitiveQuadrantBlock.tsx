...
// Preference: Mizani Africa, 7 August 2026 (the governing constraint section / the polling gap, as sourced section table). Credibility: a
// qualitative reading of how the proposal itself characterises each candidate in the field he is running against section —
...
const DATA: QuadrantPoint[] = [
  {
    ...
    note: "Leading on measured preference. the field he is running against section names fiscal competence as her exploitable gap, not her strength.",
    color: "#e31d2b",
  },
  {
    name: "Dr. Makali Mulu",
    ...
    note: "Deepest fiscal and M&E credentials in the field per the field he is running against section — the proposal's central strategic bet.",
    color: "#0056a8",
  },
  {
    ...
    note: "the field he is running against section cites steady party base as his strength; the text makes no fiscal-credibility claim about him.",
    color: "#8295a9",
  },
];
  ...
  return (
    <div className="bg-card border border-line rounded-2xl p-4 sm:p-5 shadow-sm my-6 print-avoid-break">
      ...
      <p className="t-small text-muted mb-3 leading-relaxed pl-3.5">
        Horizontal axis is measured survey data. Vertical axis is a qualitative editorial reading of the competitor profiles&apos; own
