...
/**
 * §5.5.2's nine-attribute matrix, as one card per tier.
 *
 ...
 * §5.5.2 exists to answer. The reader is choosing between three tiers, so the card is the tier:
 * swipe left, swipe right, decide. Three cards, snap-aligned, in §5.5.2's own column order —
 ...
 * is the cell as §5.5.2 prints it.
 *
