 ...
 * the whole arithmetic of the number of votes it takes section: 532,758 people are registered, about 330,310 of them will
 ...
 *
 * the indicator framework, anchored to the vote threshold section puts 200,000 at "~53.4% of expected turnout", which only holds if expected turnout is
