    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex flex-col justify-end sm:justify-center items-center print:hidden">
        ...
        <motion.div
          ...
          className="relative w-full max-w-xl max-h-[88dvh] sm:max-h-[80dvh] bg-card border-t sm:border border-line rounded-t-3xl sm:rounded-3xl shadow-2xl flex flex-col overflow-hidden z-10"
        >
