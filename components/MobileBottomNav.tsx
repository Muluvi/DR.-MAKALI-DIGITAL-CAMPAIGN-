      ...
      {isZeroChrome ? (
        ...
        <div className="fixed bottom-3 right-3 sm:right-6 z-40 lg:hidden print:hidden animate-fade-in select-none">
          <button
            ...
            className="flex items-center justify-center gap-1.5 min-h-[44px] min-w-[44px] px-3.5 py-2 rounded-full bg-card/90 backdrop-blur-xl border border-accent/30 text-ink shadow-lg active:scale-95 transition-all text-xs font-bold cursor-pointer"
      ...
      >
        <div className="bg-card/95 backdrop-blur-xl border-t border-line shadow-2xl px-2 pt-1.5 pb-[max(0.75rem,env(safe-area-inset-bottom,0.75rem))]">
          ...
          <div className="flex items-center justify-between px-1 pb-1.5 mb-1.5 border-b border-line/40 text-xs font-semibold gap-1">
            <button
              onClick={onOpenTOC}
              className="flex items-center gap-1.5 px-2.5 sm:px-3 py-1.5 rounded-xl bg-accent/10 text-accent border border-accent/20 active:scale-95 transition-all cursor-pointer min-h-[40px] shrink-0"
            >
              <ListTree size={14} />
            ...
            <div className="flex items-center gap-1 shrink-0">
              ...
              {onToggleZeroChrome && (
                <button
                  onClick={onToggleZeroChrome}
                  className="flex items-center gap-1 px-2 sm:px-2.5 py-1.5 rounded-xl bg-paper border border-line text-ink active:scale-95 transition-all cursor-pointer min-h-[40px]"
              ...
              <button
                ...
                className="flex items-center gap-1 px-2 py-1.5 rounded-xl bg-paper border border-line text-ink active:scale-95 transition-all cursor-pointer min-h-[40px]"
              ...
              <button
                ...
                className="p-2 rounded-xl bg-paper border border-line text-ink active:scale-95 transition-all cursor-pointer min-h-[40px] min-w-[40px] flex items-center justify-center"
