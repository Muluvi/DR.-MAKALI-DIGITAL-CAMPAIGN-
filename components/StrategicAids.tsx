...
// 10. (removed) Interactive Report Generator
//
// A "Print PDF Briefing Kit / Export PDF" panel used to sit on the landing screen. It offered
// the site as a printed document, which is the one thing this site is deliberately not — and
// it was the last print-document convention left in the interface. The browser's own print
// still works, and the print stylesheet still makes it look considered; there is simply no
// longer a panel inviting a reader to turn the thing back into a PDF.
