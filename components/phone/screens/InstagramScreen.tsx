...
/**
 * Instagram — a square feed carousel, which is the only format §7.1.2 actually specifies for
 ...
 *
 * The card carries §8.3.1 Pillar B — the guaranteed Ksh 85/kg ndengu floor price — with the
  ...
  return (
    <ScreenShell tone="dark" background="#ffffff">
      ...
      <div className="flex-1 min-h-0 overflow-hidden">
        ...
        {/* Square media — a designed policy card, per §7.1.2's carousel format. */}
