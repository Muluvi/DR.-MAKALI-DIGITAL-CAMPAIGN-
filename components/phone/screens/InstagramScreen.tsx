...
/**
 * Instagram — a square feed carousel, which is the only format the message assignment by segment section actually specifies for
 ...
 *
 * The card carries the four content pillars section Pillar B — the guaranteed Ksh 85/kg ndengu floor price — with the
  ...
  return (
    <ScreenShell tone="dark" background="#ffffff">
      ...
      <div className="flex-1 min-h-0 overflow-hidden">
        ...
        {/* Square media — a designed policy card, per the message assignment by segment section's carousel format. */}
