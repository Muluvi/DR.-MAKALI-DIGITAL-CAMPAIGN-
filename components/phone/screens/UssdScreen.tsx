 ...
 *
 * This is the channel that reaches the ~250,000 feature-phone voters in §3.6.2, which is more than
 ...
 *
 * The menu is §8.3.3's tree, unchanged. The pause before the response is the point — USSD is a
