 ...
 *
 * This is the channel that reaches the ~250,000 feature-phone voters in §3.8.1, which is more than
 ...
 *
 * The menu is §5.2.1.2's tree, unchanged. The pause before the response is the point — USSD is a
