 ...
 *
 * This is the channel that reaches the ~250,000 feature-phone voters in the offline majority, and the infrastructure that reaches it section, which is more than
 ...
 *
 * The menu is the copy samples: radio, SMS and USSD section's tree, unchanged. The pause before the response is the point — USSD is a
