...
// in §6.4.2 are carried as text, because a cost in shillings, a cost in dollars and a shift in
...
/** The three metrics in §6.4.2 that share no axis with the five above. */
