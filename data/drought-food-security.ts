// Phase 4c — drought and food security. Feeds the drought, food security and climate pressure section.
...
export const FOOD_RESERVE_HOUSEHOLDS: SourcedFigure = {
  ...
  provenance: {
    ...
    granularity: "county",
    note:
      "The CECM's stated household base (over 1.2 million) is markedly higher than the 2019 census household count for the whole county (262,942 — the who lives here, and what they can reach online section). Rendered exactly as stated rather than corrected; the discrepancy may reflect the CECM conflating population with households, but this pass has no second source to resolve which figure is right.",
  },
};
