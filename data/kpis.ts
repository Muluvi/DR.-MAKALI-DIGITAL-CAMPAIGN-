// The two scorecards, §8.1.1 and §8.1.2, as data.
//
...
// §8.1.1 in this repository marks NW-04 as "Confirm w/ party" instead, which is the
...
export const NOMINATION_KPIS: Kpi[] = [
  {
    ...
    targetValue: 55.0,
    unit: "percent",
    method: "Rolling 7-day Tracking Poll (N = 400 CATI) (Section 8.4)",
  ...
  },
  {
    ...
    targetValue: 60.0,
    unit: "percent",
    method: "Issue Salience Index in County Tracking Survey (Section 8.4)",
...
export const GENERAL_ELECTION_KPIS: Kpi[] = [
  {
    ...
    targetValue: 220000,
    unit: "count",
    method: "Verified opt-in 2G SMS & Baraza registration ledger (Section 8.2.2)",
...
/** The four Stage 1 headline targets, as §8.2.3's architecture diagram states them. */
