...
export const DATA_GAPS: DataGap[] = [
  ...
  { dataset: "Turnout by constituency (2022)", whyItMatters: "The ~62% county turnout figure (Section 2.3) hides real variance the targeting model needs constituency-level.", acquisitionRoute: "Official request" },
  ...
  { dataset: "KNBS population totals for the five unlisted constituencies", whyItMatters: "Section 2.5 has the county total; only Kitui Central's constituency figure is in dispute (Section 2.6) — the other five constituencies' totals were not supplied at all.", acquisitionRoute: "Official request" },
  ...
  { dataset: "Kitui health, water, electricity, unemployment and PWD indicators", whyItMatters: "The 'Economist Governor' narrative (Section 4) needs current sector indicators beyond the 2019 census baseline.", acquisitionRoute: "Official request" },
  { dataset: "Current county pending bills (post-FY2020/21)", whyItMatters: "Section 2.7 can only show the FY2020/21 figure (~KSh1.3bn) — the campaign needs the current number, not a five-year-old one.", acquisitionRoute: "Official request" },
  ...
  { dataset: "2013 Kitui gubernatorial result", whyItMatters: "Section 2.6's electoral timeline is missing its first data point entirely — no winner or vote totals were supplied for this cycle.", acquisitionRoute: "Official request" },
  { dataset: "Musila's 2022 vote total — primary IEBC declaration form", whyItMatters: "Resolves the Star-vs-Standard/Nation dispute in Section 2.6 with the single Tier 1 source that settles it.", acquisitionRoute: "Official request" },
  { dataset: "FY2025/26 Q1 CBIRR (primary document)", whyItMatters: "Resolves the 18%-vs-~5% absorption-rate dispute in Section 2.7 directly rather than via secondary reporting.", acquisitionRoute: "Official request" },
  { dataset: "Mui Basin concession count, petition status and displacement headcount", whyItMatters: "Section 2.9 currently carries qualitative statements only — no concession count, current Petition 12 of 2014 status, or displacement figure was supplied.", acquisitionRoute: "Official request" },
  { dataset: "March 2026 flooding — sub-county breakdown", whyItMatters: "Section 2.8 can only report that flooding was reported, not which sub-counties or to what extent.", acquisitionRoute: "Primary research" },
];
