...
export const NOMINATION_METHOD_CLAIM: SourcedFigure<string> = {
  ...
  provenance: {
    ...
    granularity: "county",
    note: "Not confirmed by Wiper. Section 3.1's survey-based strategy assumes this reporting is accurate — if it is wrong, the phasing in Section 1.5 needs to be revisited before it is acted on.",
  },
};
