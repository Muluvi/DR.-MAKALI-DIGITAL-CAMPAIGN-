...
export const CONTENDERS: Contender[] = [
  { name: "Dr. Irene Kasalu", position: "Woman Representative, Kitui County", stage: "Wiper ticket", note: "Currently leading on measured preference (Section 1.1). Full profile in Section 2.2." },
  { name: "Sen. Enoch Wambua", position: "Senator, Kitui County", stage: "Wiper ticket", note: "Senior Wiper standing (Section 2.2)." },
  { name: "Charity Ngilu", position: "Former Governor, Kitui County (NARC)", stage: "General election field", note: "Won the court-confirmed 2017 governor race (Section 2.6)." },
  { name: "David Musila", position: "Former Senator, Kitui County", stage: "General election field", note: "2022 runner-up figure is disputed (Section 2.6)." },
...
export const MALOMBE_TERM_LIMIT_QUESTION =
  "Malombe served as Kitui Governor 2013–2017, then lost the seat to Ngilu for the 2017–2022 term (the court-confirmed 2017 result, Section 2.6), before winning again in 2022. Whether that non-consecutive, interrupted service counts toward Kenya's two-term gubernatorial limit for a 2027 run is, on the facts established in this document, an open question with two possible readings — that interrupted terms count toward the limit, or that they do not — rather than a settled one. This proposal treats it as unresolved in all planning, per the existing framing in Section 2.2, and does not take a position on which reading is correct.";
