...
export const CONTENDERS: Contender[] = [
  { name: "Dr. Irene Kasalu", position: "Woman Representative, Kitui County", stage: "Wiper ticket", note: "Currently leading on measured preference (Section 3.1). Full profile in Section 5.2.3.2." },
  { name: "Sen. Enoch Wambua", position: "Senator, Kitui County", stage: "Wiper ticket", note: "Senior Wiper standing (§3.5)." },
